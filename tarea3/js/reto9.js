function evaluarEncuesta() {
    ...
    //Codigo para saber la opcion escogida en el input radio de la pregunta 5.
    var respuesta5 = ""
    document.getElementsByName("opinion2")
        .forEach(radio => {
         ...
         //Codigo para saber la opcion escogida en el input radio de la pregunta 6.
    var respuesta6 = ""
    ...
    if (pregunta1 == "" || pregunta2 == "" || pregunta3 == "" || respuesta4 == "" || respuesta5 == "" || respuesta6 == "") {
        ...
        if (document.formulario.atencion.checked == true && document.formulario.calidad.checked == true && document.formulario.servicio.checked == true) {
            ...
            mensaje1 = "Gracias por sus respuestas, tomaremos en cuenta sus opiniones para mejorar.";
        ...
        var mensaje4 = "";
        if (respuesta6 == "Una persona") {
            mensaje4 = "Estamos para servirle";
        } else {
            mensaje4 = "Estamos para servirle a usted y su familia";
        }
        ...
        document.getElementById("res4").innerHTML = mensaje4
    }
}
...
function limpiarFormulario() {
    ...
    var opcionesRadio4 = document.getElementsByName("opinion3");
    opcionesRadio4.forEach(radio => (radio.checked = false));
    ...
    document.getElementById("caminatas").checked = false;
    document.getElementById("cabalgatas").checked = false;
    document.getElementById("cuadraciclos").checked = false;
    document.getElementById("canopy").checked = false;
    document.getElementById("otro2").checked = false;
